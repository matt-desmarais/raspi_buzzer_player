...
def setup():
	...
	GPIO.setup(buzzer_pin3, GPIO.OUT)
	GPIO.setup(buzzer_pin4, GPIO.OUT)
	GPIO.setup(buzzer_pin5, GPIO.OUT)
...
def play(melody,tempo,pause,pace=0.800, pin):
...
if __name__ == '__main__':		# Program start from here
	try:
		...
		play(final_countdown_melody, final_countdown_tempo, 0.30, 1.2000, buzzer_pin)
		play(final_countdown_melody, final_countdown_tempo, 0.30, 1.2000, buzzer_pin2)
		time.sleep(2)
